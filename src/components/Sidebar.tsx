...
import { Plus, MessageSquare, List, Tag, Map, ArrowLeft, ListChevronsDownUp, ListChevronsUpDown, Edit, GripVertical, CircleFadingArrowUp, FileText } from 'lucide-react' // FIX: 删除未使用的Search和Container导入
